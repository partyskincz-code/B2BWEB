...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Počítejte s 24 hodinami na grafiku, jedním až dvěma dny na schválení a 5 až 20 pracovními dny na výrobu podle velikosti a složitosti projektu. U akce za dva měsíce je čas dostatečný, u akce za dva týdny se ozvěte, zkusíme expresní výrobu."
      }
    },
    {
      "@type": "Question",
